        ...
        <div className="iconformat">
          {(() => {
            switch (weatherAttributeIcon) {
              case "Clouds":
                return (
                  <AiFillCloud size={700} color="rgba(255, 255, 255, 0.219)" />
                );
              case "Rain":
                return (
                  <IoRainy size={700} color="rgba(255, 255, 255, 0.219)" />
                );
              case "Snow":
                return (
                  <BiCloudSnow size={700} color="rgba(255, 255, 255, 0.219)" />
                );
              case "Clear":
                return (
                  <TiWeatherSunny
              ...
              case "Mist":
                return (
                  <RiMistFill size={700} color="rgba(255, 255, 255, 0.219)" />
                );
              case "Haze":
                return (
                  <GiHeatHaze size={700} color="rgba(255, 255, 255, 0.219)" />
                );
              default:
                return <div></div>;
            }
